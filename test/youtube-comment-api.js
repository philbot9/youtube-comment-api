...
describe('YouTube Comment API', function () {
  ...
  it('should support callback functions', function (done) {
    this.timeout(20000);
    fetchCommentPage('pkwOrteyQtY', null, function (err, page) {
  ...
  it('should return errors for callback functions', function (done) {
    this.timeout(20000);
    fetchCommentPage('fakeID', null, function (err, page) {
      expect(err).to.exist;
  ...
  it('should return errors for promises', function (done) {
    this.timeout(20000);
    fetchCommentPage('fakeID', null).catch(function(err) {
      expect(err).to.exist;
      done();
    });
  });
