...
describe('Youtube Session', function () {
  ...
  it('should get a session token', function (done) {
    this.timeout(30000);
    getSessionToken('eKEwL-10s7E').then(function (sessionToken) {
  ...
  it('should remember a session token', function (done) {
    this.timeout(30000);
    getSessionToken('eKEwL-10s7E').then(function (sessionToken1) {
      getSessionToken('eKEwL-10s7E').then(function (sessionToken2) {
