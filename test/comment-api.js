...
describe('Comment API', function () {
  ...
  it('should get a comments page without a page token', function (done) {
    this.timeout(20000);
    getCommentsPage('eKEwL-10s7E', null).then(function (page) {
  ...
  it('should get a different comments page with a page token', function (done) {
    this.timeout(20000);
    getCommentsPage('eKEwL-10s7E', null).then(function (page1) {
      getCommentsPage('eKEwL-10s7E', page1.nextPageToken).then(function (page2) {
  ...
  it('should return different videos\' comments', function (done) {
    ...
    getCommentsPage('eKEwL-10s7E', null).then(function (page1) {
      ...
      getCommentsPage('pkwOrteyQtY', null).then(function (page2) {
